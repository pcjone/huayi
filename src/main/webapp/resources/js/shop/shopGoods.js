	...
	oTableInit.Init = function() {
		$('#data-list-table').bootstrapTable({
			...
			},
			{
				...
				sortable:true,
				formatter:function(value){
					return "<img src='../image/view/shop?path="+value+"' style='width:100px'/>";
				}
			},
			{
				field : 'goodsType',
				...
				valign: 'middle',
				sortable:true,
				formatter : dic_value_text("GOODS_TYPE"),
			},
			{
				field : 'goodsStatus',
				title : '商品状态',
				valign: 'middle',
				sortable:true,
				formatter : dic_value_text("GOODS_STATUS"),
			},
			{
				field : 'enable',
				title : '状态',
...
var ButtonInit = function() {
	...
	oButtonInit.Init = function() {
		...
		$("#edit").click(function(){
			...
			$("#preview").attr("src","../image/view/shop?path="+rows[0].goodsIcon);
