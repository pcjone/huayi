...
public class SysParam extends BaseModel {
	 ...
	 */
	private static final long serialVersionUID = -884659876086951950L;
	/**
	 * 参数key
	 */
	...
	public String toString() {
		return "SysParam [paramKey=" + paramKey + ", paramValue=" + paramValue + "]";
	}
	...
	public boolean equals(Object that) {
		...
		return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
				&& (this.getParamKey() == null ? other.getParamKey() == null
						: this.getParamKey().equals(other.getParamKey()))
