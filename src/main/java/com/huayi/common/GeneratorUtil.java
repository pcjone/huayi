...
import com.huayi.common.generator.ColumnClass;
import com.huayi.common.generator.FreeMarkerTemplateUtils;
...
public class GeneratorUtil {
	...
	public Connection getConnection() throws Exception {
		...
		Connection connection = DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/huayi?useSSL=false", "root",
				"15158133802");
		return connection;
	}
